        ...
        <div class="row align-items-center">
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand" href="{{ route('front.homepage') }}"> <img src="{{asset('uploads/settings/'.$setting->logo)}}" alt="logo"> </a>
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    @isset($categories)
                                        @foreach($categories as $category)
                                            <a class="dropdown-item" href="{{ route('front.getCourseByCategoryId',$category->id) }}">{{$category->name}}</a>
                                        @endforeach
                                    @endisset
                                </div>
                            </li>
